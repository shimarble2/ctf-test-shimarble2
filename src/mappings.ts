...
export const componentMap = {
  ...
  ContactForm: dynamic(() =>
    import('@src/components/features/ctf-components/ctf-get-in-touch/ctf-get-in-touch').then(module => module.CftGetInTouch),
  ),
};
...
export const componentGqlMap = {
  ...
  ContactForm: dynamic(() =>
    import('@src/components/features/ctf-components/ctf-get-in-touch/ctf-get-in-touch-gql').then(module => module.CtfGetInTouchGql),
  ),
