...
export const ComponentResolver = (props: Props) => {
  ...
  console.log('>componentProps.__typename', componentProps.__typename);
  ...
  console.log('>component-resolver.tsx : shouldForceGql', shouldForceGql);
  ...
  if (!Component && !ComponentGql) {
    console.log('>component-resolver.tsx: if (!Component && !ComponentGql) : null');
  ...
  // 追加
  if (Component) {
    console.log('>component-resolver.tsx : Component', Component);
  }
  if (ComponentGql) {
    console.log('>component-resolver.tsx : ComponentGql', ComponentGql);
  }
